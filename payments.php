...
$result=mysqli_query($link,$querry);
$data=mysqli_fetch_assoc($result);
$querry1= "SELECT * FROM `hostel_information` WHERE `Hostel Name` LIKE '$hostel'";
...
<div class="navbar">
  <a style="padding:.2px"><img src="logo.png" width="50px" height="50px" style="background-color: white;"> </a>
    ...
    <a href="http://localhost/phpt/project%20hw1/payments.php" class="active">Payments</a>
...
<a onclick="myFunction()" class="notification" id="navbar_l"><img src="download.png"width="25px" height="25px"style="border-radius:15px"><span class="badge"><?php echo $announcement;?></span></a>
  ...
  <h2> Your room's Light bill detail:</h2>
   <table style="border: 1px solid;font-size:20px;">
    <th style="border: 1px solid;">Room No.</th>
    <th style="border: 1px solid;">Light Bill</th>
    <th style="border: 1px solid;">Status</th>
    <tr>
      <td style="border: 1px solid;"><?php echo $data["Room No."]; ?></td>
      <td style="border: 1px solid;"><?php echo $data["Light Bill"]; ?></td>
      <td style="border: 1px solid;"><?php if($data["Light Bill Status"]==0){echo "NOT PAID";}else{echo "PAID";} ?></td>
    </tr>
    </table>  <h2> Your Hostel's Fees detail:</h2> 
    <table style="border: 1px solid; font-size:20px;">
    <th style="border: 1px solid;">Room Type</th>
    <th style="border: 1px solid;">Fees</th>
    <th style="border: 1px solid;">Status</th>
    <tr>
      <td style="border: 1px solid;"><?php echo $data["Room Type"]; ?></td>
      <td style="border: 1px solid;"><?php echo $data1[$data["Room Type"]]; ?></td>
      <td style="border: 1px solid;"><?php if($data["Fees"]==0){echo "NOT PAID";}else{echo "PAID";} ?></td>
    </tr>
    </table>
    <h3>(note:for any payment related issue contact to your hostel managment.)</h3>
    <h3>Manager's Contact No:<?php echo $data1["Manager No."]; ?></h3>
</div>
