...
<div class="navbar">
  <a style="padding:.2px"><img src="logo.png" width="50px" height="50px" style="background-color: white;"> </a>
	<a  href="http://localhost/phpt/project%20hw1/home_page.php">Home</a>
	<div class="dropdown">
    ...
    <a href="http://localhost/phpt/project%20hw1/about_us.php" class="active">About Us</a>  
...
<body>
  <div class="container">
    ...
    <p>If you have any questions or feedback, please don't hesitate to <a href="http://localhost/phpt/project%20hw1/feedback.php">contact us</a>.</p>
  </div>
</body>
</html>
